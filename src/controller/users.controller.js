...
const { validateRegisterUser, validateEmail, validateLoginUser, validateForgotPassword, validateResetPassword, validateGuestUser, validateUpdateUser } = require('../validators/users.validator')
