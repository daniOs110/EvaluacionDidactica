...
module.exports = { validateRegisterUser, validateLoginUser, validateEmail, validateForgotPassword, validateResetPassword, validateCreateEvaluation, validateAddLetter, validateGuestUser, validateUpdateUser }
